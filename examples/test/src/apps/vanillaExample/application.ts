...
import { createHelloVanillaPlugin } from './plugins/HelloVanillaPlugin/createHelloVanillaPlugin';
...
export default class Application extends TApplication {
        ...
        override async initialize(): Promise<void> {
                debugger;
                const metaPlugin = new TMetaPluginHost(TMetaPluginHost.metaclass, 'hello-vanilla', createHelloVanillaPlugin);
