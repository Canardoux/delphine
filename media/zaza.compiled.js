...
var TComponentRegistry = class extends TObject {
  ...
  buildComponentTree(form, root) {
    ...
    rootElem.querySelectorAll(":scope > [data-component]").forEach((el) => {
      const child = this.processElem(el, form, root);
